...
import { NotificationCenter } from "../chat/notification-center";
                                                                ...
                                                                <NavigationMenuLink asChild className="z-20 relative">
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <p className="text-sm leading-tight text-muted-foreground">
                                                                            Find freelancers, post projects & buy templates.
                                                                        </p>
                                                                    </Link>
                                                                </NavigationMenuLink>
                                                            </li>
                    ...
                    <div className="hidden lg:flex items-center">
                        {session?.user ? (
                            <div className="flex items-center gap-2">
                                <NotificationCenter />
                                <Link href="/chat" className={buttonVariants({ size: "sm", variant: "ghost" })}>
                                    Messages
                                </Link>
